  ...
  return (
    <>
      <div className="w-full p-2 sm:p-4 mt-4 text-dark-gray">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-[100px_1fr_auto] sm:grid-cols-[minmax(70px,150px)_minmax(150px,auto)_100px] lg:grid-cols-[200px_minmax(200px,auto)_150px] gap-y-4 sm:gap-y-6 lg:gap-y-6 gap-x-2">
          {/* 이메일 */}
          <label className="self-center text-xs sm:text-sm lg:text-base font-medium">
            이메일 <span className="text-red">*</span>
          </label>
          <input {...register('deliveryName', { required: true })} placeholder="예) 집, 회사" className="border rounded px-2 py-2 text-xs sm:text-sm lg:text-base w-full" />
          ...
          <input {...register('recipient', { required: true })} className="border rounded px-2 py-2 text-xs sm:text-sm lg:text-base w-full" />
          <span>영문 소문자/숫자/특수문자 포함 8~15자</span>
